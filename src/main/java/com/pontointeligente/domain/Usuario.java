 ...
 *//**
	...
	*//*
		 ...
		 * 
		 * @Column(name="email", nullable=false) public String getEmail() { return
		 * email; }
		 * 
		 * public void setEmail(String email) { this.email = email; }
		 * 
		 * @Column(name="senha", nullable=false) public String getSenha() { return
		 * senha; }
		 * 
		 ...
		 * 
		 * @Column (name="perfil" , nullable=false) public PerfilEnum getPerfil() {
		 * return perfil; }
		 * 
		 * public void setPerfil(PerfilEnum perfil) { this.perfil = perfil; }
		 * 
		 * @Override public String toString() { return "Usuario [id=" + id + ", email="
		 * + email + ", senha=" + senha + ", perfil=" + perfil + "]"; }
		 * 
		 * 
		 * 
		 * 
