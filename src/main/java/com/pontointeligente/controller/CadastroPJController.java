...
@RestController
@RequestMapping(ControllerHelper.API+"cadastrar-pj")
@CrossOrigin(origins = "*")
public class CadastroPJController extends ControllerBase {
	...
	@PostMapping
	public ResponseEntity<Response<CadastroPJ>> cadastrar(@Valid @RequestBody CadastroPJ cadastroPj, BindingResult result) throws NoSuchAlgorithmException {
