 ...
 * 
 * 
 * @Before public void setUp() { Empresa empresa = new
 * EmpresaBuilder().comCnpj(CNPJ).comRazaoSocial("Exemplo").build(); empresa =
 * this.respository.save(empresa); System.out.println(" :: empresa " +
 * empresa.getId()); }
 * 
